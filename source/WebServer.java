...
public class WebServer {
    ...
    private void handleTaskRequest(HttpExchange exchange) throws IOException {
        ...
        if (isDebugMode) {
            String debugMessage = String.format("La operacion tardo %d nanosegundos = %d segundos con %d milisegundos", (finishTime - startTime) ,secondsTime, milisTime);
    ...
    private byte[] calculateResponse(byte[] requestBytes) {
        Demo dm = null; // Se crea un objeto de la clase Demo
        dm = (Demo) SerializationUtils.deserialize(requestBytes); // Se deserializa el objeto
        // Imprimimos el objeto
        System.out.println("Se han recibido los siguientes datos: ");
        System.out.println(dm.a);
        System.out.println(dm.b);
        
        String ok = "Se recibieron los datos con exito";
        return ok.toString().getBytes(); // Enviamos el texto de respuesta
    }
